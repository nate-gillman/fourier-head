...
run_idxs_v1 = {
    "fourier" : {
        0 : [40, 41, 42, 43],
        1 : [1, 31, 32, 33],
        2 : [52, 53, 54, 55], # 96: [44, 45, 46, 47], 128 : [2, 23, 24, 25], 192 : [48, 49, 50, 51], 256 : [36, 37, 38, 39], 288: [NONE], 320 : [56, 57, 58, 59], 352 : [52, 53, 54, 55, 60, 61, 62, 63, 64, 65, 66, 67 [CHECK THES LAST EIGHT!!]]
        3 : [3, 8, 9, 10] # ALSO-- 68, 69, 70, 71, 72, 73, 74, 75 [CHECK THESE...]
    },
    "linear" : {
        0 : [4, 17, 18, 19],
        1 : [5, 27, 34, 35],
...
run_idxs = {
    "fourier" : {
        0 : [40, 41, 42],       # 40, 41, 42, 43, 68, 69
        1 : [1, 31, 32],        # 1, 31, 32, 33
        2 : [54, 60, 65],       # 52, 53, 54, 55, 60, 61, 62, 63, 64, 65, 66, 67
        3 : [8, 9, 10]          # 3, 8, 9, 10
    },
    "linear" : {
        0 : [17, 18, 19],       # 4, 17, 18, 19
        1 : [5, 27, 34],        # 5, 27, 34, 35, 92, 93, 94, 95, 96, 97, 98, 99, 100, 101, 102
        2 : [6, 20, 21],        # 6, 20, 21
        3 : [28, 29, 30],       # 7, 28, 29, 30
    },
}
...
def main():
    ...
    base_path = "output/11-29-pt1-ablation-model-size"
    ...
    build_graph(
        ...
        "scripts/eval/graphing/chronos_ablation_varying_model_size_v4_MASE.png",
    )
    ...
    build_graph(
        ...
        "scripts/eval/graphing/chronos_ablation_varying_model_size_v4_WQL.png"
    )

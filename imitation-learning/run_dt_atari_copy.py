...
print("Total minutes building dataset: ", (time.time() - start_time)/60)
...
# for scaling up model, we choose n_layer, n_head, n_embd. note that we need n_embd % config.n_head == 0
# perhaps we just input an idx for model size 1 thru 10
...
tconf = TrainerConfig(max_epochs=epochs, batch_size=args.batch_size, learning_rate=6e-4,
                      ...
                      num_workers=4, seed=args.seed, model_type=args.model_type, game=args.game, max_timestep=max(timesteps), args=args)
